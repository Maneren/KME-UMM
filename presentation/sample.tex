...
\begin{frame}{Urychlení a zjednodušení}
    \begin{columns}[c]
        ...
        \begin{itemize}
            ...
            \item Nahrazení složitých jevů konstantou, např. odpor vzduchu
        \end{itemize}
...
\begin{frame}{Čas}
  \begin{itemize}
    ...
    \item Pro jednoduché případy mohou být stejné (\uv{posunu objekty a vykreslím})
...
\begin{frame}{Tuhé těleso}
  \begin{itemize}
    ...
    \item My předpokládame i složení z homogenního a izotropního materiálu
    ...
    \item V každém kroku vypočítáme jejich změnu:
      ...
      \begin{equation}
        \mathbf{a}^* \mathbf{R} = \begin{bmatrix}
          \mathbf{a} \times \begin{bmatrix} r_{xx} \\ r_{xy} \\ r_{xz} \end{bmatrix} &&
          \mathbf{a} \times \begin{bmatrix} r_{yx} \\ r_{yy} \\ r_{yz} \end{bmatrix} &&
          \mathbf{a} \times \begin{bmatrix} r_{zx} \\ r_{zy} \\ r_{zz} \end{bmatrix}
        \end{bmatrix}
      \end{equation}
      \cite{witkin1997}
      \cite{blackedout01_rigid_body}
